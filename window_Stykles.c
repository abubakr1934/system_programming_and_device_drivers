#include<windows.h>
    ...
    h[1] = CreateWindow("BUTTON", "MAXIMIZEBOX",WS_MAXIMIZEBOX,100,100,150,100,0,0,hinstance,0);
    ShowWindow(h[1], nCmdShow);

    h[2] = CreateWindow("BUTTON", "MINIMIZEBOX",WS_MINIMIZEBOX,200,200,150,100,0,0,hinstance,0);
    ...
    MessageBox(0,"hi", "Devashree Ambegaokar",MB_OK);
    return 0;
}
